...
import { getAllRestaurants, createRestaurant, updateRestaurant, deleteRestaurant, approveRestaurant, getMyRestaurant } from '../controller/restaurantController.js';
...
router.get('/my-restaurant', protect, authorizeRoles('restaurant_owner'), getMyRestaurant);                                   
